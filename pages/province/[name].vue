...
//ชื่อจังหวัด
const province_name = ref<string>(route.params.name as string)
            ...
            <div class="max-w-[100dvw] px-12 2xl:px-24">
                ...
                <div class="w-[100%] flex items-center mb-6">
                    <p class="text-[28px] font-bold mr-auto">
                        {{ (keyword === undefined || keyword === '' || keyword === null) ? `${language.page.province.title} ${province_name}` : `${language.page.province.search_result} : ${keyword}`}}
                    </p>
                ...
                <div class="max-w-[100%] h-fit">
                    ...
                    <template v-if="search_status === false">
                        <div class="w-[100%] h-[150px] flex items-center justify-center">
                            <p class="text-[32px] font-bold">{{language.page.province.not_result_search}}</p>
                        </div>
                    </template>
                    ...
                    <template v-else-if="search_status === true">
                        <div class="grid grid-cols-4 gap-x-[2%] gap-y-8 w-[100%]">
                            ...
                            <div class="w-[100%]">
                                <ItemSearch :dataItem="TravelDataTest" link="/place/7" />
                            </div>
                            <div class="w-[100%]">
                                <ItemSearch :dataItem="TravelDataTest" link="/place/8" />
                            </div>
                            <div class="w-[100%]">
                                <ItemSearch :dataItem="TravelDataTest" link="/place/9" />
                            </div>
                            <div class="w-[100%]">
                                <ItemSearch :dataItem="TravelDataTest" link="/place/10" />
                            </div>
                            <div class="w-[100%]">
                                <ItemSearch :dataItem="TravelDataTest" link="/place/11" />
                            </div>
                            <div class="w-[100%]">
                                <ItemSearch :dataItem="TravelDataTest" link="/place/12" />
                            </div>
                        </div>
                    </template>
                </div>
