        ...
        <div class="modal-overlay items-center">
            ...
            <div v-show="showTrasition" class="bg-[#fdfdfd] rounded-lg h-fit w-[45%] 2xl:w-[35%]">
                ...
                <div class="modal-body w-[100%] flex flex-col">
                    <p class="text-[30px] text-center leading-[34px] font-extrabold mb-5">Login Form</p>
                    <div class="mx-auto relative w-[80%] h-[50px]">
                        <input 
                            class="mx-auto w-full h-full pl-[4.1rem] text-[18px] font-medium placeholder-[#909090] rounded-md shadow-inner shadow-[#8a8a8a] bg-[#d1d1d1] focus:outline-none" 
                        ...
                        <div class="absolute inset-y-0 left-0 pl-[1.4rem] flex items-center pointer-events-none">
                            <font-awesome-icon :icon="['fas', 'user']" class="text-[26px]" />
                        </div>
                    </div>
                    <div class="mx-auto relative w-[80%] h-[50px] mt-5">
                        ...
                        />
                        <div class="absolute inset-y-0 left-0 pl-[1.4rem] flex items-center pointer-events-none">
                            <font-awesome-icon :icon="['fas', 'lock']" class="text-[26px]" />
                        </div>
                    </div>
                    ...
                    <div class="mx-auto w-[80%] my-4 flex justify-between items-center">
                        <div class="h-6 w-fit flex items-center">
                            ...
                            <p class="text-[18px] leading-4 font-medium text-[#0c0c0c] select-none">Keep Login</p>
                        </div>

                        <p class="text-[18px] leading-4 font-semibold text-[#0277BD] cursor-pointer select-none">Forgot password?</p>
                    </div>

                    <div class="mx-auto w-[80%] space-y-5">

                        <button
                            class="w-full h-[50px] rounded-md bg-[#FFA624] hover:bg-[#d68923] shadow-md shadow-[#d0d0d0]  text-[24px] font-bold text-white focus:outline-none mb-5"
                        >
                            Log in
                        </button>
                        ...
                        <button
                            class="w-full h-[50px] rounded-md bg-[#FF5722] hover:bg-[#F93E03] shadow-inner shadow-[#00000055] text-[24px] font-bold text-white focus:outline-none"
                        >
                            Register
                        </button>
                        </NuxtLink>
                    ...
                    <div class="mx-auto w-[80%] space-y-5 mb-12">
                        ...
                        <button
                            class="w-full h-[50px] flex items-center justify-center rounded-md bg-[#01579B] hover:bg-[#2b5884] shadow-inner shadow-[#0000007e] text-[20px] font-bold text-white focus:outline-none"
                        >
                        ...
                        <button
                            class="w-full flex items-center justify-center h-[50px] rounded-md bg-[#fffefe] hover:bg-[#f5f4f4] shadow-inner shadow-[#0000002e] text-[20px] font-bold text-black border-2 border-black focus:outline-none"
                        >
                            <div class="w-[10%] h-fit flex items-center justify-center">
                        ...
                        <button
                            class="w-full flex items-center justify-center h-[50px] rounded-md bg-[#00B900] hover:bg-[#349f2e] shadow-inner shadow-[#00000058] text-[20px] font-bold text-white focus:outline-none"
                        >
                            <div class="w-[10%] h-fit flex items-center justify-center">
